...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { name: 'Instagram', href: '#', icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.024.06 1.378.06 3.808s-.012 2.784-.06 3.808c-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.024.048-1.378.06-3.808.06s-2.784-.013-3.808-.06c-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.048-1.024-.06-1.378-.06-3.808s.012-2.784.06-3.808c.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 016.345 2.525c.636-.247 1.363-.416 2.427-.465C9.793 2.013 10.147 2 12.315 2zm0 1.623c-2.403 0-2.72.01-3.667.058-1.146.052-1.602.248-1.922.458-.426.28-.765.624-1.043 1.043-.28.426-.624.765-1.043 1.043-.28.426-.624.765-1.043 1.043-.21.32-.406.776-.458 1.922-.048.947-.058 1.264-.058 3.667s.01 2.72.058 3.667c.052 1.146.248 1.602.458 1.922.28.426.624.765 1.043 1.043.426.28.765.624 1.043 1.043.32.21.776.406 1.922.458.947.048 1.264.058 3.667.058s2.72-.01 3.667-.058c1.146-.052 1.602-.248 1.922-.458.426-.28.765-.624 1.043-1.043.28-.426.624-.765 1.043-1.043.32-.21.406-.776.458-1.922.048-.947.058-1.264.058-3.667s-.01-2.72-.058-3.667c-.052-1.146-.248-1.602-.458-1.922-.28-.426-.624-.765-1.043-1.043-.426-.28-.765-.624-1.043-1.043-.32-.21-.776-.406-1.922-.458-.947-.048-1.264-.058-3.667-.058zM12 6.865a5.135 5.135 0 100 10.27 5.135 5.135 0 000-10.27zm0 1.623a3.512 3.512 0 110 7.024 3.512 3.512 0 010-7.024zM16.536 6.808a1.2 1.2 0 100 2.4 1.2 1.2 0 000-2.4z" clipRule="evenodd"></path></svg>
    )},
  ];

  return (
    <footer className="w-full bg-transparent border-t border-white/5 pt-16 pb-8 mt-auto overflow-hidden">
